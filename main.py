...
servDf = pd.read_csv('Arquivos\BaseServiçosPrestados.csv', encoding='latin1')
cliDf = pd.read_csv('Arquivos\CadastroClientes.csv')
funcDf = pd.read_csv('Arquivos\CadastroFuncionarios.csv', sep=';', decimal=',')
